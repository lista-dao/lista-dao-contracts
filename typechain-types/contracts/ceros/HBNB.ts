...
export interface HBNBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface HBNB extends BaseContract {
  connect(runner?: ContractRunner | null): HBNB;
  waitForDeployment(): Promise<this>;

  interface: HBNBInterface;
