...
export interface CeVaultV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "changeCeToken"
      | "changeRouter"
...
export interface CeVaultV2 extends BaseContract {
  connect(runner?: ContractRunner | null): CeVaultV2;
  waitForDeployment(): Promise<this>;

  interface: CeVaultV2Interface;
  ...
  ): TypedContractMethod<[ceTokenAddress: AddressLike], [void], "nonpayable">;
  getFunction(
