...
export interface ICertTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ICertToken extends BaseContract {
  connect(runner?: ContractRunner | null): ICertToken;
  waitForDeployment(): Promise<this>;

  interface: ICertTokenInterface;
