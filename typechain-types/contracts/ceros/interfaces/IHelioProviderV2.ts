...
export interface IHelioProviderV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOfToken"
      | "daoBurn"
...
export interface IHelioProviderV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IHelioProviderV2;
  waitForDeployment(): Promise<this>;

  interface: IHelioProviderV2Interface;
