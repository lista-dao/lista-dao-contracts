...
export interface WNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WNative extends BaseContract {
  connect(runner?: ContractRunner | null): WNative;
  waitForDeployment(): Promise<this>;

  interface: WNativeInterface;
