...
export interface LisUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PERMIT_TYPEHASH"
...
export interface LisUSD extends BaseContract {
  connect(runner?: ContractRunner | null): LisUSD;
  waitForDeployment(): Promise<this>;

  interface: LisUSDInterface;
  ...
  resetSymbol: TypedContractMethod<[], [void], "nonpayable">;
