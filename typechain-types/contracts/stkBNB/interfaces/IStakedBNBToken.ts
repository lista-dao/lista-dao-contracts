...
export interface IStakedBNBTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
...
export interface IStakedBNBToken extends BaseContract {
  connect(runner?: ContractRunner | null): IStakedBNBToken;
  waitForDeployment(): Promise<this>;

  interface: IStakedBNBTokenInterface;
