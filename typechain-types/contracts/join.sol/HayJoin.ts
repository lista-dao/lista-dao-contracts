...
export interface HayJoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cage"
      | "deny"
...
export interface HayJoin extends BaseContract {
  connect(runner?: ContractRunner | null): HayJoin;
  waitForDeployment(): Promise<this>;

  interface: HayJoinInterface;
  ...
  initialize: TypedContractMethod<
    [vat_: AddressLike, hay_: AddressLike],
    [void],
    "nonpayable"
  >;
