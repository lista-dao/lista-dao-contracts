...
export interface SnBnbStakeManagerMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "changeER"
      | "changeSnBnb"
...
export interface SnBnbStakeManagerMock extends BaseContract {
  connect(runner?: ContractRunner | null): SnBnbStakeManagerMock;
  waitForDeployment(): Promise<this>;

  interface: SnBnbStakeManagerMockInterface;
  ...
  changeSnBnb: TypedContractMethod<[_snBnb: AddressLike], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "changeSnBnb"
  ): TypedContractMethod<[_snBnb: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[_amountInSnBnb: BigNumberish], [bigint], "view">;
  getFunction(
