...
export declare namespace StkBnbStrategy {
...
export interface MockStkBnbStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "assessDepositFee"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "setupDistribute",
    values: [StkBnbStrategy.WithdrawRequestStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "setupDistributeManual",
...
export interface MockStkBnbStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): MockStkBnbStrategy;
  waitForDeployment(): Promise<this>;

  interface: MockStkBnbStrategyInterface;
  ...
  setupDistribute: TypedContractMethod<
    [_withdrawReqs: StkBnbStrategy.WithdrawRequestStruct[]],
    [void],
    "payable"
  >;

  setupDistributeManual: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setupDistribute"
  ): TypedContractMethod<
    [_withdrawReqs: StkBnbStrategy.WithdrawRequestStruct[]],
    [void],
    "payable"
  >;
  getFunction(
    nameOrSignature: "setupDistributeManual"
  ): TypedContractMethod<
    [recipient: AddressLike, amount: BigNumberish],
    [void],
    "payable"
