...
export interface BnbxYieldConverterStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "assessDepositFee"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "bnbxToUnstake",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace StakeManagerChangedEvent {
...
export interface BnbxYieldConverterStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): BnbxYieldConverterStrategy;
  waitForDeployment(): Promise<this>;

  interface: BnbxYieldConverterStrategyInterface;
  ...
  bnbxToUnstake: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getEvent(
    key: "StakeManagerChanged"
  ): TypedContractEvent<
    StakeManagerChangedEvent.InputTuple,
    StakeManagerChangedEvent.OutputTuple,
    StakeManagerChangedEvent.OutputObject
  >;
  getEvent(
    key: "UpdatedRewards"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "StakeManagerChanged(address)": TypedContractEvent<
      StakeManagerChangedEvent.InputTuple,
      StakeManagerChangedEvent.OutputTuple,
      StakeManagerChangedEvent.OutputObject
    >;
    StakeManagerChanged: TypedContractEvent<
      StakeManagerChangedEvent.InputTuple,
      StakeManagerChangedEvent.OutputTuple,
      StakeManagerChangedEvent.OutputObject
    >;
