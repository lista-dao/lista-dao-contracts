...
contract AsBnbOracle is AccessControlUpgradeable, UUPSUpgradeable {
   ...
   */
  function initialize(address _admin, address _abBnbMinter) public initializer {
   ...
   *      by multiplying slisBNB's price from resilient oracle
   *      and the conversion rate from asBnbMinter
   */
  function peek() public view returns (bytes32, bool) {
    ...
    return (bytes32(uint(price) * asBnbMinter.convertToTokens(10**10)), true);
  }
