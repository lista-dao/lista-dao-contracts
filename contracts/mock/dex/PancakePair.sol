...
contract PancakePair is PancakeERC20 {
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        ...
        uint256 balance0 = IXERC20(token0).balanceOf(address(this));
        uint256 balance1 = IXERC20(token1).balanceOf(address(this));
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        uint256 balance0 = IXERC20(_token0).balanceOf(address(this));
        uint256 balance1 = IXERC20(_token1).balanceOf(address(this));
        ...
        balance0 = IXERC20(_token0).balanceOf(address(this));
        balance1 = IXERC20(_token1).balanceOf(address(this));
    ...
    function skim(address to) external lock {
        ...
        _safeTransfer(
            _token0,
            to,
            IXERC20(_token0).balanceOf(address(this)).sub(reserve0)
        );
        _safeTransfer(
            _token1,
            to,
            IXERC20(_token1).balanceOf(address(this)).sub(reserve1)
        );
    }
    ...
    function sync() external lock {
        _update(
            IXERC20(token0).balanceOf(address(this)),
            IXERC20(token1).balanceOf(address(this)),
            reserve0,
            reserve1
        );
    }
