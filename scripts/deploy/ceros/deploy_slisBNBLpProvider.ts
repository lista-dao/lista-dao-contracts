...
async function main() {
    ...
    if (hre.network.name === "bsc") {
        ...
        manager = '0xB68443Ee3e828baD1526b3e0Bdf2Dfc6b1975ec4' // interaction
        ...
        manager = '0x70C4880A3f022b32810a4E9B9F26218Ec026f279'
    ...
    const ytslisBNBStakeVault = await upgrades.deployProxy(contractFactory, [
        deployer, manager, pauser, collateralToken, certToken, daoAddress, collateralReserveAddress, exchangeRate, userCollateralRate
