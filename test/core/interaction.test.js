...
describe('===Interaction===', function () {
    ...
    beforeEach(async function () {
        [deployer, signer1, signer2] = await hardhat_1.ethers.getSigners();
        // Contract factory
        this.Spot = await hardhat_1.ethers.getContractFactory("Spotter");
        this.Vat = await hardhat_1.ethers.getContractFactory("Vat");
        this.Oracle = await hardhat_1.ethers.getContractFactory("Oracle");
        this.Hay = await hardhat_1.ethers.getContractFactory("Hay");
        this.HayJoin = await hardhat_1.ethers.getContractFactory("HayJoin");
        this.Vow = await hardhat_1.ethers.getContractFactory("Vow");
        this.HelioRewards = await hardhat_1.ethers.getContractFactory("HelioRewards");
        this.ABNBC = await hardhat_1.ethers.getContractFactory("aBNBc");
        this.ABNBB = await hardhat_1.ethers.getContractFactory("aBNBb");
        this.GemJoin = await hardhat_1.ethers.getContractFactory("GemJoin");
        this.Clipper = await hardhat_1.ethers.getContractFactory("Clipper");
        this.hBNB = await hardhat_1.ethers.getContractFactory("hBNB");
        this.HelioProvider = await hardhat_1.ethers.getContractFactory("HelioProvider");
        this.CeRouter = await hardhat_1.ethers.getContractFactory("CerosRouter");
        this.CeToken = await hardhat_1.ethers.getContractFactory("CeToken");
        this.BinancePool = await hardhat_1.ethers.getContractFactory("BinancePool");
        this.StakingPool = await hardhat_1.ethers.getContractFactory("StakingPool");
        this.Factory = await hardhat_1.ethers.getContractFactory("PancakeFactory");
        this.wBNB = await hardhat_1.ethers.getContractFactory("wBNB");
        wbnb = await this.wBNB.deploy();
        this.LinearDecrease = await hardhat_1.ethers.getContractFactory("LinearDecrease");
        factory = await this.Factory.deploy(deployer.address);
        this.Router = await hardhat_1.ethers.getContractFactory("PancakeRouter");
        ...
        await abnbc.initialize(hardhat_1.ethers.ZeroAddress, abnbb.target);
        ...
        await dex.addLiquidityETH(abnbc.target, reserve_0, reserve_0 / 2n, reserve_0, deployer.address, 9999999999, { value: reserve_0 });
        this.AuctionProxy = await hardhat_1.ethers.getContractFactory("AuctionProxy");
        auctionProxy = await this.AuctionProxy.connect(deployer).deploy();
        await auctionProxy.waitForDeployment();
        this.Interaction = await hardhat_1.ethers.getContractFactory("Interaction", {
            libraries: {
                AuctionProxy: auctionProxy.target
            }
        });
        this.Jug = await hardhat_1.ethers.getContractFactory("Jug");
        this.Dog = await hardhat_1.ethers.getContractFactory("Dog");
        // Contract deployment
        ...
        this.CeVault = await hardhat_1.ethers.getContractFactory("CeVault");
        ...
        await ceRouter.initialize(abnbb.target, wbnb.target, ceToken.target, abnbb.target, ceVault.target, dex.target, binancePool.target);
        ...
        await oracle.connect(deployer).setPrice((0, utils_1.toWad)("400"));
    });
    describe('--- initialize()', function () {
        it('initialize', async function () {
            ...
            (0, chai_1.expect)(await interaction.vat()).to.be.equal(vat.target);
        });
    });
    describe('--- rely()', function () {
        it('reverts: Interaction/not-authorized', async function () {
            await (0, chai_1.expect)(interaction.rely(signer1.address)).to.be.revertedWith("Interaction/not-authorized");
            (0, chai_1.expect)(await interaction.wards(signer1.address)).to.be.equal("0");
        });
        it('relies on address', async function () {
            ...
            (0, chai_1.expect)(await interaction.wards(signer1.address)).to.be.equal("1");
        });
    });
    describe('--- deny()', function () {
        it('reverts: Interaction/not-authorized', async function () {
            await (0, chai_1.expect)(interaction.deny(signer1.address)).to.be.revertedWith("Interaction/not-authorized");
        });
    ...
    describe('--- enableWhitelist()', function () {
        it('reverts: Interaction/not-authorized', async function () {
            await (0, chai_1.expect)(interaction.enableWhitelist()).to.be.revertedWith("Interaction/not-authorized");
        });
        it('enable whitelist mode', async function () {
            ...
            (0, chai_1.expect)(await interaction.whitelistMode()).to.be.equal("1");
        });
    });
    describe('--- disableWhitelist()', function () {
        it('reverts: Interaction/not-authorized', async function () {
            await (0, chai_1.expect)(interaction.disableWhitelist()).to.be.revertedWith("Interaction/not-authorized");
        });
        it('disable whitelist mode', async function () {
            ...
            (0, chai_1.expect)(await interaction.whitelistMode()).to.be.equal("0");
        });
    });
    describe('--- setWhitelistOperator()', function () {
        it('reverts: Interaction/not-authorized', async function () {
            await (0, chai_1.expect)(interaction.setWhitelistOperator(signer1.address)).to.be.revertedWith("Interaction/not-authorized");
        });
        it('set whitelist operator', async function () {
            ...
            (0, chai_1.expect)(await interaction.whitelistOperator()).to.be.equal(signer1.address);
        });
    });
    describe('--- addToWhitelist()', function () {
        it('reverts: Interaction/not-operator-or-ward', async function () {
            await (0, chai_1.expect)(interaction.addToWhitelist([signer1.address])).to.be.revertedWith("Interaction/not-operator-or-ward");
        });
        it('set whitelist operator', async function () {
            await vat.initialize();
            await spot.initialize(vat.target);
            ...
            (0, chai_1.expect)(await interaction.whitelist(signer1.address)).to.be.equal("1");
        });
    });
    describe('--- removeFromWhitelist()', function () {
        it('reverts: Interaction/not-operator-or-ward', async function () {
            await (0, chai_1.expect)(interaction.removeFromWhitelist([signer1.address])).to.be.revertedWith("Interaction/not-operator-or-ward");
        });
        it('set whitelist operator', async function () {
            await vat.initialize();
            await spot.initialize(vat.target);
            ...
            (0, chai_1.expect)(await interaction.whitelist(signer1.address)).to.be.equal("0");
            (0, chai_1.expect)(await interaction.whitelist(signer2.address)).to.be.equal("1");
        });
    });
    ...
    describe('--- setCollateralType()', function () {
        it('set collateral type', async function () {
            ...
            await interaction.setCollateralType(ceToken.target, ceabnbcJoin.target, collateral, clip.target, (0, utils_1.toRay)("0.75"));
        });
        it('reverts: Interaction/token-already-init', async function () {
            ...
            (0, chai_1.expect)(interaction.setCollateralType(ceToken.target, ceabnbcJoin.target, collateral, clip.target, (0, utils_1.toRay)("0.75"))).to.be.revertedWith("Interaction/token-already-init");
        });
    });
    describe('--- setCollateralDuty()', function () {
        it('reverts: Interaction/inactive collateral', async function () {
            ...
            await spot.rely(interaction.target);
            // await interaction.setCollateralType(ceToken.target, ceabnbcJoin.target, collateral, clip.target, toRay("0.75"));
            (0, chai_1.expect)(interaction.setCollateralDuty(ceToken.target, (0, utils_1.toRay)("0.002"))).to.be.revertedWith("Interaction/inactive collateral");
        });
        it('set collateral duty', async function () {
            ...
            await spot.rely(interaction.target);
            await interaction.setCollateralType(ceToken.target, ceabnbcJoin.target, collateral, clip.target, (0, utils_1.toRay)("0.75"));
            await interaction.setCollateralDuty(ceToken.target, (0, utils_1.toRay)("2"));
            const [duty,] = await jug.ilks(collateral);
            (0, chai_1.expect)(duty).to.be.equal("2" + ray);
    ...
    describe('--- removeCollateralType()', function () {
        it('remove collateral type', async function () {
            ...
            (0, chai_1.expect)(live).to.be.equal(2);
            (0, chai_1.expect)(await vat.wards(ceabnbcJoin.target)).to.be.equal(0);
            (0, chai_1.expect)(res).to.emit(interaction, "CollateralDisabled");
        });
    });
    describe('--- setHelioProvider()', function () {
        it('set Helio provider for collateral', async function () {
            ...
            (0, chai_1.expect)(await interaction.helioProviders(ceToken.target)).to.be.equal(helioRewards.target);
        });
    });
    describe('--- deposit()', function () {
        it('deposit through HelioProvider with aBNBc should revert', async function () {
            ...
            await (0, chai_1.expect)(helioProvider.provideInABNBc("1" + wad)).to.be.revertedWith("HelioProvider/Disabled");
            await (0, chai_1.expect)(helioProvider.provide({ value: 1000 })).to.emit(helioProvider, "Deposit").withArgs(deployer.address, "1000");
        });
    });
    describe('--- borrow()', function () {
        it('borrow HAY', async function () {
            ...
            await vat["file(bytes32,uint256)"](toBytes32("Line"), (0, utils_1.toRad)("20000"));
            await vat["file(bytes32,bytes32,uint256)"](collateral, toBytes32("line"), (0, utils_1.toRad)("20000"));
            await vat["file(bytes32,bytes32,uint256)"](collateral, toBytes32("spot"), (0, utils_1.toRay)("0.8"));
            const borrowAmount = "1" + wad;
            await interaction.borrow(ceToken.target, borrowAmount);
            (0, chai_1.expect)(await hay.balanceOf(deployer.address)).to.be.equal(borrowAmount);
        });
    });
    describe('--- payback()', function () {
        it('payback borrowed hay', async function () {
            ...
            (0, chai_1.expect)(await hay.balanceOf(deployer.address)).to.be.equal("2" + wad);
        });
    });
    describe('--- withdraw()', function () {
        it('withdraw collateral via HelioProvider', async function () {
            ...
            await (0, chai_1.expect)(helioProvider.releaseInABNBc(deployer.address, "1" + wad)).to.emit(helioProvider, "Withdrawal").withArgs(deployer.address, deployer.address, "1" + wad);
            (0, chai_1.expect)(await abnbb.balanceOf(deployer.address)).to.be.equal(beforeReleaseBalance + (0, utils_1.toWad)("1"));
        });
    });
    describe('--- stringToBytes32()', function () {
        it('return bytes32 for string', async function () {
            const tempString = "aBNBc";
            (0, chai_1.expect)(await interaction.stringToBytes32(tempString)).to.be.equal(toBytes32(tempString));
        });
    });
    describe('--- drip()', function () {
        it('update vow surplus', async function () {
            ...
            await jug["file(bytes32,uint256)"](toBytes32("base"), (0, utils_1.toRay)("0.000002"));
            ...
            await (0, utils_1.advanceTime)(60);
            await interaction.drip(ceToken.target);
            const afterHayBalance = await vat.hay(vow.target);
            (0, chai_1.expect)(beforeHayBalance).to.be.equal(0);
            (0, chai_1.expect)(afterHayBalance).to.be.gt(0);
        });
    });
    describe('--- poke()', function () {
        it('poke collateral price', async function () {
            ...
            (0, chai_1.expect)(res).to.emit(interaction, "Poke");
            await jug["file(bytes32,uint256)"](toBytes32("base"), (0, utils_1.toRay)("0.000000002"));
            await jug["file(bytes32,address)"](toBytes32("vow"), vow.target);
            await vat["file(bytes32,uint256)"](toBytes32("Line"), (0, utils_1.toRad)("20000"));
            await vat["file(bytes32,bytes32,uint256)"](collateral, toBytes32("line"), (0, utils_1.toRad)("20000"));
            await vat["file(bytes32,bytes32,uint256)"](collateral, toBytes32("spot"), (0, utils_1.toRay)("0.8"));
            ...
            (0, chai_1.expect)(afterSpot).to.be.not.equal(beforeSpot);
        });
    });
    describe('--- read states via view functions', function () {
        it('read prices and collateral states', async function () {
            ...
            (0, chai_1.expect)(await interaction.collateralPrice(ceToken.target)).to.be.equal((0, utils_1.toWad)("400"));
            const [, rate, , ,] = await vat.ilks(collateral);
            (0, chai_1.expect)(await interaction.hayPrice(ceToken.target)).to.be.equal(rate / 1000000000n);
            (0, chai_1.expect)(await interaction.collateralRate(ceToken.target)).to.be.equal((0, utils_1.toWad)("0.8")); // 0.8 = 1 / 1.25
            (0, chai_1.expect)(await interaction.depositTVL(ceToken.target)).to.be.equal((0, utils_1.toWad)("4000")); // 10 * 400 in $
            const collateralTVL = await interaction.collateralTVL(ceToken.target);
            (0, chai_1.expect)(await interaction.free(ceToken.target, deployer.address)).to.be.equal(0);
            (0, chai_1.expect)(await interaction.locked(ceToken.target, deployer.address)).to.be.equal((0, utils_1.toWad)("10"));
            (0, chai_1.expect)(await interaction.borrowed(ceToken.target, deployer.address)).to.be.equal(collateralTVL + 100n); // 100 Wei is added as a ceiling to help close CDP in repay()
            (0, chai_1.expect)(await interaction.availableToBorrow(ceToken.target, deployer.address)).to.be.equal(6999999877999992679n);
            (0, chai_1.expect)(await interaction.willBorrow(ceToken.target, deployer.address, (0, utils_1.toWad)("1"))).to.be.equal(7799999877999992679n);
            (0, chai_1.expect)(await interaction.currentLiquidationPrice(ceToken.target, deployer.address)).to.be.equal(125000015250000000n);
            (0, chai_1.expect)(await interaction.estimatedLiquidationPrice(ceToken.target, deployer.address, (0, utils_1.toWad)("1"))).to.be.equal(113636377500000000n);
            (0, chai_1.expect)(await interaction.estimatedLiquidationPriceHAY(ceToken.target, deployer.address, (0, utils_1.toWad)("1"))).to.be.equal(125000000125000015n);
            (0, chai_1.expect)(await interaction.borrowApr(ceToken.target)).to.be.equal(6514815689033158807n);
        });
    });
    describe('--- Auction Scenario', function () {
        it('auction should be started and bought as expected', async function () {
            ...
            await interaction.borrow(ceToken.target, borrowAmount);
            await oracle.connect(deployer).setPrice((0, utils_1.toWad)("120"));
            ...
            (0, chai_1.expect)(sale.usr).to.not.be.equal(hardhat_1.ethers.ZeroAddress);
            const dink = (0, utils_1.toWad)("100");
            ...
            await hay.connect(signer1).approve(interaction.target, (0, utils_1.toWad)("701"));
            await hay.connect(signer2).approve(interaction.target, (0, utils_1.toWad)("1001"));
            ...
            await interaction.connect(signer1).buyFromAuction(ceToken.target, 1, (0, utils_1.toWad)("7"), (0, utils_1.toRay)("100"), signer1.address);
            await interaction.connect(signer2).buyFromAuction(ceToken.target, 1, (0, utils_1.toWad)("3"), (0, utils_1.toRay)("100"), signer2.address);
            ...
            (0, chai_1.expect)(abnbbSigner1BalanceAfter - abnbbSigner1BalanceBefore).to.be.equal((0, utils_1.toWad)("7"));
            (0, chai_1.expect)(abnbbSigner2BalanceAfter - abnbbSigner2BalanceBefore).to.be.equal((0, utils_1.toWad)("3"));
            const saleAfter = await clip.sales(1);
            (0, chai_1.expect)(saleAfter.pos).to.equal(0);
            (0, chai_1.expect)(saleAfter.tab).to.equal(0);
            (0, chai_1.expect)(saleAfter.lot).to.equal(0);
            (0, chai_1.expect)(saleAfter.tic).to.equal(0);
            (0, chai_1.expect)(saleAfter.top).to.equal(0);
            (0, chai_1.expect)(saleAfter.usr).to.equal(hardhat_1.ethers.ZeroAddress);
            const [status, , ,] = await interaction.getAuctionStatus(ceToken.target, 1);
            (0, chai_1.expect)(status).to.be.equal(false);
            const allActiveAuctions = await interaction.getAllActiveAuctionsForToken(ceToken.target);
            (0, chai_1.expect)(allActiveAuctions.length).to.be.equal(0);
        });
        it('--- resetAuction()', async function () {
            ...
            const borrowAmount = "1000" + wad;
            await interaction.borrow(ceToken.target, borrowAmount);
            await oracle.setPrice((0, utils_1.toWad)("120"));
            await interaction.poke(ceToken.target);
    ...
    describe('--- upchostClipper()', function () {
        it('refresh chost for collateral', async function () {
            ...
            (0, chai_1.expect)(after).be.not.equal(before);
        });
    });
    describe('--- totalPegLiquidity()', function () {
        it('read total supply of hay', async function () {
            ...
            (0, chai_1.expect)(res).to.be.equal(borrowAmount);
        });
    });
});
