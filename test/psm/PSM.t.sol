...
contract PSMTest is Test {
    ...
    function test_depositAndWithdraw() public {
        ...
        console.log("user1 lisUSD 0: ", lisUSDBalance / 1 ether);

        psm.buyGem(100 ether);
        ...
        console.log("user1 lisUSD 1: ", lisUSDBalance / 1 ether);

        vm.stopPrank();

    }

    function test_hMatch() public {
        uint256 duty = 1000000005781378656804590540;
        uint256 duration = 3600 * 24 * 365;
        uint256 res = hMath.rpow(duty, duration, hMath.ONE);
