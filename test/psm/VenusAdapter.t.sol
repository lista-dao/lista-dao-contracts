...
contract VenusAdapterTest is Test {
    ...
    function setUp() public {
        ...
        TransparentUpgradeableProxy venusAdapterProxy = new TransparentUpgradeableProxy(
            ...
            address(proxyAdmin),
            abi.encodeWithSelector(venusAdapterImpl.initialize.selector, venusPool, USDC, vUSDC)
        );

        venusAdapter = VenusAdapter(address(venusAdapterProxy));

        venusAdapter.setEarnPool(user1);
        vm.stopPrank();
    ...
    function test_depositAndWithdraw() public {
        ...
        uint256 gemAmount = venusAdapter.getStakedGem();
        console.log("Staked USDC:: ", gemAmount);


//        vm.startPrank(user1);
//        venusAdapter.withdraw(user1, 100 ether);
//        vm.stopPrank();
...
//        console.log("vUSDC: ", vUSDCBalance);
        ...
        gemAmount = venusAdapter.getStakedGem();
        console.log("Staked USDC:: ", gemAmount);
